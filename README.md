...
| :---------------------------: | --------------------------- |--------------------------- | :---------------------------: |
| 1 | Вводный проект. Музыка больших городов | Сравнивали данные пользователей Яндекс.Музыки по разным городам и дням недели для выявления предпочтений | Python, Pandas |
...
| 4 | Определение перспективного тарифа для телеком-компании | Анализировали поведение клиентов и выбирали лучший тариф на основе данных. Применяли статистический анализ и проверку гипотез | Python, Pandas, Matplotlib, NumPy, SciPy |
